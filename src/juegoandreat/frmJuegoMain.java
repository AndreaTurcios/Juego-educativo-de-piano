...
public class frmJuegoMain extends javax.swing.JFrame {
    ...
    private void jbtncancionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtncancionActionPerformed
        ...
        if (cont_final == 0) 
        {
            while (simonDice == true) 
            {
                if (btnC1.addMouseListener(ml)  && simonDice == true) 
                {
                    cont_1++;
                }
                else if (Tecla_1 == true AND Simon == true) 
                {
                    cont_2++;
                }                
                else if (Tecla_1 == true AND Simon == true) 
                ...
                cont_final = cont_1 + cont_2 + cont_3 + cont_4 + cont_5 + cont_6 + cont_7+ cont_8 + cont_9 + cont_10 + cont_11 + cont_12 +  cont_13 + cont_14;
                txtPuntaje = cont_final;
            }
        } 
        else
        {
